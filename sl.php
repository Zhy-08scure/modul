...
class Shortlinks {
      ...
      if ($this->provider_sl == "Syid") {
         $supported = [
            ...
            "clk.sh" => ["sl_link" => "Clksh",
               "cd" => rand(60, 90)],
            #"dutchycorp2" => ["sl_link" => "dutchycorp2","cd" => rand(90, 120)],
            #"dutchy corp 8" => ["sl_link" => "dutchycorp2","cd" => rand(90, 120)],
	...
	#		"bitss.sbs" => "bitss",
         ...
         $supported = [
            ...
            "cashurl.win" => ["sl_link" => "cashurl",
               "cd" => rand(90, 120)],
            "avashortener.com" => ["sl_link" => "avashortener.com", "cd" => rand(90, 120)],
            "easyshort" => ["sl_link" => "easyshort", "cd" => rand(90, 120)],
            "easyshortxyz" => ["sl_link" => "easyshort", "cd" => rand(90, 120)],
            "exfoary" => ["sl_link" => "ex-foary.com", "cd" => rand(90, 120)],
            "ex-foary.com" => ["sl_link" => "ex-foary.com", "cd" => rand(90, 120)],
            "paycut" => ["sl_link" => "paycut", "cd" => rand(90, 120)],
            "cryptolink" => ["sl_link" => "cryptolink", "cd" => rand(90, 120)],
   ...
   public function Bypass($name, $shortlink) {
      if ($this->provider_sl == "Syid") {
         ...
         $url = explode('"&', explode('url:"', $r[1])[1])[0];
         if (!$r) {
            print x("Server Down", n); unlink('cookie.txt');return 0;
         }
         if ($url) {
            return $url;
         } elseif (preg_match('/Not support link/', $r[1])) {
            print x($r[1], d); l(); unlink('cookie.txt');return 0;
            #print_r($r[1]);return 0;
         } else {
            print x($r[1], n); l();unlink('cookie.txt');return 0;
            #print_r($r[1]);return 0;#exit;
         }
      } else {
         while (1) {
            ...
            if ($r['url']) {
               ...
               print x($r['fail'], n); l();$i = 0;
               unlink('cookie.txt');sleep(2); break;
            } elseif ($r['msg']) {
               #print "Ini msg".n;
               print x($r['msg'], n); l();
               unlink('cookie.txt');sleep(2); break;
               ...
               #print "Ini error".n;
               print x($r['error'], n); l();
               unlink('cookie.txt');break; // error from server, prevent your balance from being problematic
            } else {
               print x("No respon from server", n); l(); 
               unlink('cookie.txt');sleep(5); break;
            }
         }
      }
   }
